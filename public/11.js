    ...
    data: function data() {
        return {
            ...
            headers: [{
                ...
                align: 'left',
                value: 'id'
            }, { text: 'Nombre', value: 'nombre' }, { text: 'Apellido', value: 'apellido' }, { text: 'Usuario', value: 'usuario' }, { text: 'Rol', value: 'rol' }, { text: 'Estado', value: 'estado' }, { text: 'Acciones', value: 'action', sortable: false }],
            error: 0,
            errorMsj: [],
            usuarios: [],
            roles: [],
                  ...
                  scopedSlots: _vm._u([
                    {
                      ...
                      fn: function(props) {
                        return [
                          ...
                          _c(
                            "td",
                            { staticClass: "justify-right layout px-0" },
                            [
                              props.item.estado
                                ? _c(
                                    "v-icon",
