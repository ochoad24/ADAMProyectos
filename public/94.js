...
var settle = __webpack_require__(2196);
var buildURL = __webpack_require__(2198);
var parseHeaders = __webpack_require__(2199);
var isURLSameOrigin = __webpack_require__(2200);
var createError = __webpack_require__(1021);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(2201);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(2202);
...
var enhanceError = __webpack_require__(2197);
...
var utils = __webpack_require__(530);
var bind = __webpack_require__(1019);
var Axios = __webpack_require__(2194);
var defaults = __webpack_require__(723);
...
axios.Cancel = __webpack_require__(1023);
axios.CancelToken = __webpack_require__(2208);
axios.isCancel = __webpack_require__(1022);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(2209);
...
var defaults = __webpack_require__(723);
var utils = __webpack_require__(530);
var InterceptorManager = __webpack_require__(2203);
var dispatchRequest = __webpack_require__(2204);
...
var utils = __webpack_require__(530);
var transformData = __webpack_require__(2205);
var isCancel = __webpack_require__(1022);
var defaults = __webpack_require__(723);
var isAbsoluteURL = __webpack_require__(2206);
var combineURLs = __webpack_require__(2207);
...
var Cancel = __webpack_require__(1023);
...
Component.options.__file = "resources/components/pages/src/permiso.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07069ec4", Component.options)
  } else {
    hotAPI.reload("data-v-07069ec4", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_axios__ = __webpack_require__(2192);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            headers: [{
                ...
                align: 'left',
                value: 'id'
            }, { text: 'Nombre', value: 'nombre' }, { text: 'Rol', value: 'rol' }],
            roles: [],
            permisos: [],
            editedIndex: -1,
            editedItem: {
    ...
    methods: {
        validate: function validate() {
            this.error = 0;
            this.errorMsj = [];
            if (!this.editedItem.nombre) this.errorMsj.push('El nombre del permiso no puede estar vacio');
            if (!this.idRol) this.errorMsj.push('Se debe asignar un rol al permiso');
        ...
        initialize: function initialize() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/Permiso').then(function (response) {
                _this.permisos = response.data;
        ...
        select: function select() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/Rol').then(function (response) {
        ...
        deleteItem: function deleteItem(item) {
            ...
            swal.fire({
                ...
                if (result.value) {
                    __WEBPACK_IMPORTED_MODULE_2_axios___default.a.delete('/Permiso/' + item.id + '/delete').then(function (response) {
                        me.initialize();
                        swal.fire({
                            position: 'top-end',
                            type: 'success',
      ...
      [
        _c(
          "b-card",
          {
            ...
            attrs: { header: "Permisos", "header-tag": "h4" }
          },
          [
            _c(
              "div",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-07069ec4", module.exports)
  }
}
...
var update = __webpack_require__(26)("169fbe7e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07069ec4\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07069ec4\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
var bind = __webpack_require__(1019);
var isBuffer = __webpack_require__(609);
...
var utils = __webpack_require__(530);
var normalizeHeaderName = __webpack_require__(2195);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(1020);
