...
var update = __webpack_require__(27)("2ff10e98", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("3e7a92c6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("4434d5b5", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_layout_clear_header__ = __webpack_require__(577);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_layout_left_side_default_left_side__ = __webpack_require__(585);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_layout_right_side__ = __webpack_require__(607);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("3e4ea3e2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("67bf1c69", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        cargarProyecto: function cargarProyecto() {
            var me = this;
            fetch('api/v1/proyecto/select').then(function (response) {
    ...
    _c(
      ...
      [
        _c("router-link", { staticClass: "logo", attrs: { to: "/" } }, [
          _c("img", {
            attrs: { src: __webpack_require__(584), alt: "logo" }
          })
        ]),
        _vm._v(" "),
                                ...
                                return [
                                  _c(
                                    ...
                                    _vm._g(
                                      {
                                        staticClass:
                                          "navbar-btn sidebar-toggle fa fa-fw fa-arrow-down"
                                      },
                                      on
                                    )
                                  )
                        ...
                        "\n                            " +
                          _vm._s(
                            this.$store.state.user.nombre +
                              " " +
                              this.$store.state.user.apellido
                          ) +
                          "\n                        "
                      )
                    ])
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("0a6ac464", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu__ = __webpack_require__(589);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__menu__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__left_profile_user_profile_vue__ = __webpack_require__(602);
...
exports.vmenu = __webpack_require__(590);
exports.vsubMenu = __webpack_require__(593);
exports.vmenuItem = __webpack_require__(599);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("32861682", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs__ = __webpack_require__(597);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("2c829f1c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        [
            ...
            [
              ...
              this.$store.state.user.role == 0
                ? [
                    ...
                    _c("center", [
                      _c("h4", {
                        staticStyle: { color: "#668C2D" },
                        domProps: {
                          textContent: _vm._s(
                            this.$store.state.proyecto.nombre === ""
                              ? "Proyecto: N/S"
                              : "Proyecto: " + this.$store.state.proyecto.nombre
                          )
                        }
                      })
                    ])
          ...
          _c(
            ...
            [
              _c(
                "vmenu-item",
                { attrs: { link: "/", icon: "fa fa-fw fa-tasks" } },
                [
                  _vm._v(
              ...
              _vm._v(" "),
              this.$store.state.user.role == 0 ? _c("hr") : _vm._e(),
              _vm._v(" "),
              this.$store.state.user.role == 0
                ? _c(
                    "vmenu-item",
              ...
              this.$store.state.user.role == 1
                ...
                : _vm._e(),
              _vm._v(" "),
              this.$store.state.user.role == 1 ? _c("hr") : _vm._e(),
              _vm._v(" "),
              this.$store.state.user.role == 0
                ? _c(
                    "vmenu-item",
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__right_side_bar__ = __webpack_require__(609);
