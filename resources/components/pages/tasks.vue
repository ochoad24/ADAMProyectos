            ...
            <div class="todoside-menu">
                <div class="row">
                    <div class="col-12 col-md-5 col-lg-3">
                        <div class="side-content ">
                            <div class="box-shadow">
                                ...
                                <a href="#/task" class="alltasks border-bottom border-secondary d-block p-3 active"><i class="fa fa-tasks" aria-hidden="true"></i>&nbsp; All Tasks</a>
                                <a href="#/task" class="today d-block p-3"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp;Today's Tasks (10)</a>
                                <a href="#/task" class="needaction d-block p-3"><i class="fa fa-reply" aria-hidden="true"></i> &nbsp;Action Needed Taks (25)</a>
                                <a href="#/task" class="important d-block p-3"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> &nbsp;Important Tasks (13)</a>
                                <a href="#/task" class="pending d-block p-3"><i class="fa fa-clock-o" aria-hidden="true"></i> &nbsp;Pending Taks (15)</a>
                                <a href="#/task" class="deleted d-block p-3"><i class="fa fa-trash-o" aria-hidden="true"></i> &nbsp;Deleted Tasks</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-7 col-lg-9">
                        ...
                        <div class="tasks-list mt-5 mb-3">
                            <div class="task-type p-3">
                                <h4>All Tasks</h4>
                            </div>

                            <vue-scrollbar classes="tasks-my-scrollbar" ref="Scrollbar">
                                <div class="tasks-scroll-me">
                                    <div class="tasks-table-list table-responsive" >
                                        <table class="table">
...
<style>
    @import '../../../node_modules/vue2-scrollbar/dist/style/app.css';
