                            ...
                            <div class="col-12 col-sm-4 col-lg-3">
                                <div class="box-shadow mt-4">
                                    <div class="border-bottom border-secondary p-3">
                                        <img :src='require("../../img/authors/avatar1.jpg")' alt="user profile" class="contact-profile d-inline-block rounded-circle">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deletecontact (index) {//                this.$refs.deletemodal.show()
