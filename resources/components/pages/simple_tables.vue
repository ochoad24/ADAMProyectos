    ...
    <div>
        <div class="row">
            <div class="col-lg-6">
                ...
                <card title="<i class='ti-layout-cta-left'></i> Basic Table">
            ...
            <div class="col-lg-6">
                <!-- First Basic Table strats here-->
                <card title="<i class='ti-menu'></i> Bordered Table">
                    <div class="table-responsive">
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-list'></i> Data Table with Action buttons">
                    <div class="table-responsive">
        ...
        <div class="row">
            <div class="col-md-6">
                <card title="<i class='ti-list-ol'></i> Basic Table 2">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
            ...
            <div class="col-md-6">
                <card title="<i class='ti-list-ol'></i> Basic Table 3">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-layout-grid3'></i> Responsive Table">
                    <div class="table-responsive">
