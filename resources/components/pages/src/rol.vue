<template>
    <div class="row user-list">
        <div class="col-lg-12">
            <b-card header="Roles" header-tag="h4" class="bg-primary-card">
                    ...
                    <v-toolbar flat color="white">
                        ...
                        <v-dialog v-model="dialog" max-width="600px">
                            <template v-slot:activator="{ on }">
                                <v-btn color="#668c2d" dark class="mb-2" v-on="on">Nuevo Rol</v-btn>
                            </template>
                            <v-card>
                                    ...
                                    <v-container grid-list-md>
                                        <v-layout wrap>
                                            <v-flex xs12 sm12 md12>
                                                <v-text-field v-model="editedItem.nombre" label="Nombre Rol"  maxlength="100"  required :rules="nameRules" :counter="100">
                                                </v-text-field>
                                            </v-flex>
                                        </v-layout>
                                    </v-container>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            v => (v && v.length <= 99) || 'El nombre del rol no puede ser mayor a 100',
